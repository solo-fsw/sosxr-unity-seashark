...
namespace SOSXR.SeaShark
{
    ...
    public class StimulusBuilderExample : MonoBehaviour
    {
        ...
        public void ResetStimulus()
        {
            ...
            {
                Debug.LogWarning($"{nameof(StimulusBuilderExample)} on '{name}' requires a BaseStimulus asset.", this);
        ...
        {
            Debug.Log($"Current Stimulus: {_currentStimulus.Description} | Duration: {_currentStimulus.Duration:F3}s | Intensity: {_currentStimulus.Intensity:F2}", this);
        }
    }
}
