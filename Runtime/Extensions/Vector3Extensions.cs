...
namespace SOSXR.SeaShark
{
    ...
    public static class Vector3Extensions
    {
        ...
        /// <param name="range">
        ///     The maximum absolute value of random offsets that can be added
        ///     or subtracted to/from each component of the vector.
        /// </param>
        /// <returns>
        ///     A new <see cref="Vector3" /> with random offsets applied to its X, Y, and Z components.
